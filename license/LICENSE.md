...
You may use, copy, modify, and share this software **for non‑commercial purposes only**.
...
The full, legally binding text of the PolyForm Noncommercial License 1.0.0 is available at:

https://polyformproject.org/licenses/noncommercial/1.0.0/

This file summarizes the license and provides the required reference to the official text.
